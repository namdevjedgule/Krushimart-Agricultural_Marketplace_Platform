...
<!-- Navbar -->
    ...
    <!-- Second Navbar -->
    <div class="row" id="second-navbar" style="margin-right: 20px;">
        <div class="container">
            <div class="row">
                <div class="col-md-3" >
                    <div class="applogo" >
                ...
                <div class="col-md-3" style="display: flex;" style="margin-top: 20px; margin-left: 100px;">
                    <div class="row" style="margin-top: 20px;">
                        ...
                        <div class="col-md-8" >
                           <p>8669586311 <br> jedgulenamdev@gmail.com </p> 
    ...
    <div id="third-navbar" style="background-color: rgb(15, 173, 15);">
        <div class="">
            <nav class="navbar navbar-expand-lg navbar-light ml-5" style="margin-left: 180px !important;">
                <a class="navbar-brand font-weight-bold" href="HomePage.jsp">  </a>
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                  <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                      <a class="nav-link  text-white" href="ProfilePage.jsp"></a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link  text-white" href="AboutPage.jsp"></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  text-white" href="Contact.jsp"></a>
                      </li>
                  </ul>
